...
public abstract class AbstractSprite implements ISprite {
	...
	public boolean isCollidedWith(ISprite other) {
		if(this.getBoundingBox().overlaps(other.getBoundingBox())){    // Collision if overlapping (of bounded boxes)
		  if(!this.isAlien() && other.isAlien() || this.isAlien() && !other.isAlien()){  // And they are of different types
			 return true;
		  }
		}
		return false;
